...
var soloColumnQuery = require("./query/solo.js");
var multColumnQuery = require("./query/mult.js");

function Column(colObj) {
  var _this = this;
  _this._colObj = colObj;
  _.forIn(soloColumnQuery, function(value, key) {
...
function Columns(colObjs) {
  ...
  _.forIn(multColumnQuery, function(value, key){
