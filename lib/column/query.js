...
exports.columns.dataTypesMatch = function(colObjs){
  var promises = _.map(colObjs,function(c){
    return exports.column.dataType(c);
  });
...
exports.columns.getCompatibleDataTypes = function(colObjs){
  var promises = _.map(colObjs,function(c){
    return exports.column.dataType(c);
  });
  return Promise.all(promises)
...
exports.columns.dataTypesCompatible = function(colObjs){
  //TODO: figure out which data types are compatible
};
