...
exports.table.duplicates = function(knex,fq_table_name,match_column_names){
  ...
  _.forEach(_.rest(match_column_names),function(m){
    query_str+= "and " + helpers.parseTableColumn('inner',m) + " = " + helpers.parseTableColumn('outer',m) + " ";
  })
  query_str += ") > 1";
...
exports.table.groupByDuplicates = function(knex,fq_table_name,match_column_names){
    return exports.table.duplicates(knex,fq_table_name,match_column_names)
        .then(function(results){
...
exports.table.deleteWhere = function(knex,fq_table_name,args){
...
exports.table.copy = function(knex,fq_table_name,new_fq_table_name){
