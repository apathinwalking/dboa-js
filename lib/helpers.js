...
exports.quoteDotSep = function(str){
    return str.replace(exports.regex.byDot,'"$1"');
};

exports.doubleQuote = function(str){
    return '"' + str + '"';
};
...
exports.wrapAssign = function(obj, func) {
  return function(args) {
    if (Array.isArray(args)) {
      var assigned = _.map(args, function(a) {
        return _.assign({},obj, a);
      });
      return func(assigned);
    } else {
      return func(_.assign({},obj, args));
    }
};
};
...
exports.mapToObj = function(values, keys) {
  return _.reduce(_.range(values.length), function(obj, i) {

  }, {});
};

exports.dblQuoteFqTableName = function(fq_table_name){
  var parsed =  _.words(fq_table_name,/[^\.]+/g);
