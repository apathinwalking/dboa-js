...
exports.compareColumnNames = function(knex,tableIds,compareFunction,outputColumnName){
    "use strict";
...
exports.compareColumnNamesEquality = function(knex,tableIds){
    "use strict";
    var deferred = Q.defer();
    exports.compareColumnNames(knex,tableIds,function(a,b){
        if(a === b){return 1;}
        else{return 0;}
    },'equality')
...
exports.compareColumnNamesEditDistance = function(knex,tableIds){
    "use strict";
    var deferred = Q.defer();
    exports.compareColumnNames(knex,tableIds,leven,'edit_distance')
        .then(function(results){
            deferred.resolve(results)
        });
    return deferred.promise;
...
exports.Compare = help.mapKnex(exports);
