...
exports.utils._unionOnQuery = function(knex,src_column_name,fq_table_name1,fq_table_name2,src_value1,src_value2,matched_column_names1,matched_column_names2,unmatched_column_names1,unmatched_column_names2,matched_as){
    var query1 = knex
        .from(fq_table_name1);
...
exports.utils.unionOn = function(knex,src_column_name,fq_table_name1,fq_table_name2,src_value1,src_value2,matched_column_names1,matched_column_names2,unmatched_column_names1,unmatched_column_names2,matched_as){
...
exports.utils.createUnionTable = function(knex,new_fq_table_name,src_column_name,fq_table_name1,fq_table_name2,src_value1,src_value2,matched_column_names1,matched_column_names2,unmatched_column_names1,unmatched_column_names2,matched_as){
    var union = exports.utils._unionOnQuery(knex,src_column_name,fq_table_name1,fq_table_name2,src_value1,src_value2,matched_column_names1,matched_column_names2,unmatched_column_names1,unmatched_column_names2,matched_as)
...
exports.utils.createUnionTable_ = function(knex,args){
    return exports.utils.createUnionTable(knex,args.new_fq_table_name,args.src_column_name,args.fq_table_name1,args.fq_table_name2,args.src_val1,args.src_val2,args.matched_column_names1,args.matched_column_names2,args.unmatched_column_names1,args.unmatched_column_names2,args.matched_as);
}
