...
var columnCompare = require('./compare/column.js');

var columnFactory = function(opts){
    ...
    instance.compareWith = function(opts){
        var newColumn = columnFactory(opts);
        return columnCompare(this,newColumn);
    };
