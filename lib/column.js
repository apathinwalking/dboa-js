...
Column.prototype.rowCount = function(){
    ...
    if(_this.row_count){
        ...
        return Promise.resolve(queries.column.rowCount(_this.knex,_this.fq_table_name,_this.column_name))
...
Column.prototype.nullCount = function(){
    ...
    if(_this.null_count){
        ...
        return Promise.resolve(queries.column.nullCount(_this.knex,_this.fq_table_name,_this.column_name))
            .then(function(results){
...
exports.createColumn = function(knex,args){
